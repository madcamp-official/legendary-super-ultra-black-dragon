...
현재 저장소의 `0.4.22` 소스 버전을 기준으로 문서·qualification 계약을 정비했습니다. 과거 버전의 사용자용 변경 내역은 신뢰할 수 있는 릴리스 메모가 없으므로 소급해서 추정·작성하지 않습니다.
...
`0.4.21`은 문서 체계 정비의 이전 source 기준선입니다. 해당 버전의 미실행 수용 기록은
[v0.4.21 수용 증적](docs/release-evidence/v0.4.21.md)으로 보존하며, 현재 source·package와
새 배포의 실행 증거로 사용하지 않습니다.
