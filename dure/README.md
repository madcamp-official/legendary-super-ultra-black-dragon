...
- [설정 참조서](docs/configuration-reference.md)
- [CLI 명령 참조](docs/cli-reference.md)
...
- [개인정보·프롬프트 처리 정책](docs/data-privacy.md) — 현재 데이터 등급, node 운영자의 가시성, logging·incident 경계
- [네트워크·방화벽 운영 절차](docs/networking.md) — Controller·Agent·Ray/vLLM·NCCL 통신 경계와 포트 검증
- [외부 추론 API 경계](docs/external-inference-boundary.md) — 현재 공개 gateway 미지원 범위와 별도 gateway 필수 조건
...
- [SLO·벤치마크 정책 운영 절차](docs/slo-benchmark-policy.md) — SLO 기준선, evidence 재검증, 승격 승인 절차
...
저장소 차원의 라이선스·기여·보안·행동·지원 정책은 상위 [저장소 README](../README.md)를 따릅니다.
