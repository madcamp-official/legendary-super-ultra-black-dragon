...
> 이 문서는 이전의 통합 운영 절차를 보존한 상세 참조입니다. 일상 운영은 역할별 runbook인
> [Controller 운영](controller-operations.md), [배포·Fleet 운영](deployment-operations.md),
> [아티팩트·캐시 운영](artifact-cache-operations.md), [레거시 업그레이드](legacy-upgrades.md)와
> [운영 절차 허브](operations.md)를 우선 사용합니다.
